-- Loading MySQL Class
require "resources/lsrp/lib/MySQL"

-- MySQL:open("IP", "databasname", "user", "password")
MySQL:open("10.0.0.98", "gta5_gamemode_lsrp", "root", "1202")
...
function registerUser(source, password)
	if not hasAccount(source) then
		...
		TriggerClientEvent('chatMessage', source, 'SYSTEM', {0, 255, 0}, "💡type /help for a list of commands and press M for Player Menu.")
